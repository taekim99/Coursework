...
public class TestMusicService {
    public static void main(String[] args) {
        ...
        System.out.println("ORIGINAL STUDY SONGS PLAYLIST BY USER " + u0);
        for(Playlist p : MusicService.getUserPlaylists(u0)) {
            System.out.println(p);
        }

        System.out.println("ORIGINAL STUDY SONGS PLAYLIST BY USER " + u1);
        ...
        System.out.println("UPDATED PLAYLISTS BY USER " + u1);
        for(Playlist p : MusicService.getUserPlaylists(u1)) {
            System.out.println(p);
        }
